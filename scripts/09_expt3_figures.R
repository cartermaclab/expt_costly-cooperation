...
#-- [ SCRIPT SETUP ] ----
source(here::here("scripts/08_expt3_analysis.R"))

#-- [[ Color and theme setup ]]
expt3_colour_theme <- c("#9cde9f", "#008000", "#004b23")
...
fig2c <- ggplot(
  ...
  scale_color_manual(values = expt3_colour_theme) +
  geom_boxplot(
    lwd = 1,
     median.linewidth = 1,
    alpha = 0,
    color = expt3_colour_theme
    ) +
  stat_summary(
    fun = "mean",
    geom = "segment",
...
(fig2c + plot_annotation(
  tag_levels = list("c"),
  subtitle = "Experiment 3: Shared Kinarm End-Point Lab") &
    theme(
...
ggsave(
  "fig2c.png", # or whatever filename you want to use
  device = "png",
...
ggsave(
  "fig3c.png", # or whatever filename you want to use
  device = "png",
  path = "figs", # where ever you want to save it
  width = 11,
  height = 8.5,
...
fig4c <- ggplot(
  ...
  scale_colour_manual(values = expt3_colour_theme) +
  geom_boxplot(
    aes(fill = as.factor(trial_mode)),
    lwd = 1,
     median.linewidth = 1,
...
ggsave(
  "fig4c.png", # or whatever filename you want to use
  device = "png",
  path = "figs", # where ever you want to save it
  width = 11,
  height = 8.5,
