...
#-- [ SCRIPT SETUP ] ----
source(here::here("scripts/01_expt1_wrangle.R"))


#-- [ BEHAVIOURAL DATA ]

#-- [[ Proportion of together choices ]]
expt1_total_choices_count <- expt1_choice_tib |>
  dplyr::count(trial_mode)

expt1_choice_descriptives <- expt1_choices_p |>
...
set.seed(1234)
WRS2::onesampb(
  x = expt1_choices_p$proportion[expt1_choices_p$trial_mode == "4"],
  est = "median",
  nv = 0.5,
)
##-- Robust location estimate: 0.45
##-- 0.95% confidence interval: 0.35 0.5389
##-- p-value: 0.4845
...
#-- [[ Omnibus test ]]
expt1_prop_together_aov <- afex::aov_ez(
  data = expt1_together_choices_b,
  id = "sub_id",
  dv = "proportion",
  within = "box_number"
)
expt1_prop_together_aov
...
effectsize::rm_d(
  expt1_together_choices_b_wide$`4`, expt1_together_choices_b_wide$`8`, adjust = FALSE
)
effectsize::rm_d(
  expt1_together_choices_b_wide$`4`, expt1_together_choices_b_wide$`12`, adjust = FALSE
)
effectsize::rm_d(
  expt1_together_choices_b_wide$`8`, expt1_together_choices_b_wide$`12`, adjust = FALSE
)
...
#--    - trial mode only
#--    - box number only ]]
expt1_trial_time_descriptives <- expt1_mean_time_b_p_tm |>
...
expt1_forced_time_descriptives <- expt1_mean_time_p_tm |>
  dplyr::group_by(trial_mode) |>
  dplyr::summarize(
    n = n(),
    mean_time = mean(mean_trial_time, na.rm = TRUE),
...
expt1_box_time_descriptives <- expt1_mean_time_p_b |>
...
#-- [[ Omnibus test ]]
expt1_trial_time_aov <- afex::aov_ez(
  data = expt1_mean_time_b_p_tm,
  id = "sub_id",
  dv = "mean_trial_time",
  within = c("trial_mode", "box_number")
)
expt1_trial_time_aov
...
effectsize::rm_d(
  expt1_mean_time_b_p_tm_wide$alone_4, expt1_mean_time_b_p_tm_wide$alone_8, adjust = FALSE
)
effectsize::rm_d(
  expt1_mean_time_b_p_tm_wide$alone_4, expt1_mean_time_b_p_tm_wide$alone_12, adjust = FALSE
)
effectsize::rm_d(
  expt1_mean_time_b_p_tm_wide$alone_8, expt1_mean_time_b_p_tm_wide$alone_12, adjust = FALSE
)

effectsize::rm_d(
  expt1_mean_time_b_p_tm_wide$together_4, expt1_mean_time_b_p_tm_wide$together_8, adjust = FALSE
)
effectsize::rm_d(
  expt1_mean_time_b_p_tm_wide$together_4, expt1_mean_time_b_p_tm_wide$together_12, adjust = FALSE
)
effectsize::rm_d(
  expt1_mean_time_b_p_tm_wide$together_8, expt1_mean_time_b_p_tm_wide$together_12, adjust = FALSE
)

effectsize::rm_d(
  expt1_mean_time_b_p_tm_wide$alone_4, expt1_mean_time_b_p_tm_wide$together_4, adjust = FALSE
)
effectsize::rm_d(
  expt1_mean_time_b_p_tm_wide$alone_8, expt1_mean_time_b_p_tm_wide$together_8, adjust = FALSE
)
effectsize::rm_d(
  expt1_mean_time_b_p_tm_wide$alone_12, expt1_mean_time_b_p_tm_wide$together_12, adjust = FALSE
)
...
#--    - trial mode only
#--    - box number only ]]
expt1_distance_descriptives <- expt1_mean_distance_b_p_tm |>
  dplyr::group_by(trial_mode, box_number) |>
  dplyr::summarize(
    n = n(),
...
expt1_forced_distance_descriptives <- expt1_mean_distance_p_tm |>
  dplyr::group_by(trial_mode) |>
  dplyr::summarize(
    n = n(),
    mean_time = mean(mean_distance, na.rm = TRUE),
...
expt1_box_distance_descriptives <- expt1_mean_distance_p_b |>
  dplyr::group_by(box_number) |>
  dplyr::summarize(
    n = n(),
    mean_time = mean(mean_distance, na.rm = TRUE),
...
#-- [[ Omnibus test ]]
expt1_distance_aov <- afex::aov_ez(
  data = expt1_mean_distance_b_p_tm,
  id = "sub_id",
  dv = "mean_distance",
  within = c("trial_mode", "box_number")
)
...
effectsize::rm_d(
  expt1_mean_distance_b_p_tm_wide$alone_4, expt1_mean_distance_b_p_tm_wide$alone_8, adjust = FALSE
)
effectsize::rm_d(
  expt1_mean_distance_b_p_tm_wide$alone_4, expt1_mean_distance_b_p_tm_wide$alone_12, adjust = FALSE
)
effectsize::rm_d(
  expt1_mean_distance_b_p_tm_wide$alone_8, expt1_mean_distance_b_p_tm_wide$alone_12, adjust = FALSE
)

effectsize::rm_d(
  expt1_mean_distance_b_p_tm_wide$together_4, expt1_mean_distance_b_p_tm_wide$together_8, adjust = FALSE
)
effectsize::rm_d(
  expt1_mean_distance_b_p_tm_wide$together_4, expt1_mean_distance_b_p_tm_wide$together_12, adjust = FALSE
)
effectsize::rm_d(
  expt1_mean_distance_b_p_tm_wide$together_8, expt1_mean_distance_b_p_tm_wide$together_12, adjust = FALSE
)

effectsize::rm_d(
  expt1_mean_distance_b_p_tm_wide$alone_4, expt1_mean_distance_b_p_tm_wide$together_4, adjust = FALSE
)
effectsize::rm_d(
  expt1_mean_distance_b_p_tm_wide$alone_8, expt1_mean_distance_b_p_tm_wide$together_8, adjust = FALSE
)
effectsize::rm_d(
  expt1_mean_distance_b_p_tm_wide$alone_12, expt1_mean_distance_b_p_tm_wide$together_12, adjust = FALSE
)
