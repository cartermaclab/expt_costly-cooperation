...
#-- [ SCRIPT SETUP ] ----
source(here::here("scripts/05_expt2_analysis.R"))

#-- [[ Color and theme setup ]]
expt2_colour_theme <- c("#89c2d9", "#014f86", "#03045e")
...
fig2b <- ggplot(
  ...
  scale_color_manual(values = expt2_colour_theme) +
  geom_boxplot(
    lwd = 1,
    median.linewidth = 1,
    alpha = 0,
    color = expt2_colour_theme
    ) +
  stat_summary(
    fun = "mean",
    geom = "segment",
...
(fig2b + plot_annotation(
  tag_levels = list("b"),
  subtitle = "Experiment 2: Online Visual Feedback") &
    theme(
...
ggplot2::ggsave(
  "fig2b.png", # or whatever filename you want to use
  device = "png",
...
ggplot2::ggsave(
  "fig3b.png", # or whatever filename you want to use
  device = "png",
  path = "figs", # where ever you want to save it
  width = 11,
  height = 8.5,
...
ggplot2::ggsave(
  "fig4b.png", # or whatever filename you want to use
  device = "png",
  path = "figs", # where ever you want to save it
  width = 11,
  height = 8.5,
